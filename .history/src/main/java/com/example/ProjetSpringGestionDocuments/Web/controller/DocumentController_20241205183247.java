...
import com.example.ProjetSpringGestionDocuments.Web.model.AuthorForm;
...
public class DocumentController {
    ...
    public String showAddAuthorForm(Model model) {
        ...
        return "AddAuthor"; // Name of the HTML template for the form
    }

    @PostMapping("/authors/create")
    public String addAuthor(@Valid @ModelAttribute("authorForm") AuthorForm authorForm, 
        ...
        try {
            ...
            return "redirect:/documents"; // Redirect to the document list
        } catch (Exception e) {
...
public String showAddDocumentPage(Model model) {
    ...
    model.addAttribute("fileFormats", FileFormatRepository.findAll());  // Ensure this line is working
    ...
    public String addDocument(
        ...
        try {
            ...
            // Trouver fileFormat à l'aide de l'ID
            FileFormat fileFormat = FileFormatRepository.findById(documentForm.getFileformat_id())
                    .orElseThrow(() -> new RuntimeException("File format not found: " + documentForm.getFileformat_id()));
