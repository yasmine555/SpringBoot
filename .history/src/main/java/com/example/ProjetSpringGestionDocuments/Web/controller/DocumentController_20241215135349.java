...
public String addDocument(
    ...
    try {
        ...
        File uploadDirectory = new File(uploadDir); // Resolves to ../DocumentUploadsdirectory
        ...
        if (!documentFile.isEmpty()) {
            ...
            String relativePath = "uploaddirectory/" + fileName; // Ensure this matches the URL pattern
