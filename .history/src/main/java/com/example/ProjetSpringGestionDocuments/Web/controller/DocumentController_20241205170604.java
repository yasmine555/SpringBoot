...
public class DocumentController {
    ...
    @GetMapping("/documents/authors")
    public String showAddAuthorPage(Model model) {
        model.addAttribute("documentForm", new DocumentForm());
        model.addAttribute("name", AuthorRepository.findAll());
        model.addAttribute("email", AuthorRepository.findAll());
        return "AddAuthor";
    }
    ...
    public String addDocument(
        ...
        try {
            ...
            FileFormat fileFormat = FileFormatRepository.findById(documentForm.getFileformat_id())
                    .orElseThrow(() -> new RuntimeException("FILE FORMAT introuvable : " + documentForm.getFileformat_id()));
    ...
    public String addAuthor(
        ...
        try {
            // Trouver l'auteur à l'aide de l'ID
            Author author = AuthorRepository.findById(authorForm.getAuthor_id())
                    .orElseThrow(() -> new RuntimeException("Auteur introuvable : " + documentForm.getAuthor_id()));
