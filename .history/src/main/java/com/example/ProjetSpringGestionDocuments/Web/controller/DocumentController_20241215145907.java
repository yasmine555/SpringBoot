...
java.util.Date utilDate = document.getPublishDate();  // Assuming this returns a java.util.Date
java.sql.Date sqlDate = new java.sql.Date(utilDate.getTime());  // Convert to java.sql.Date

// Assuming this is a java.sql.Date
if (sqlDate != null) {  // Use sqlDate here instead of publishDate
    documentForm.setPublishDate(sqlDate.toLocalDate());  // Convert to LocalDate
}
