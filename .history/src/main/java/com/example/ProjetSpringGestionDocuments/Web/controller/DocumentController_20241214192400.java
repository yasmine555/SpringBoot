    ...
    public String addDocument(
        ...
        try {
            ...
            Category category = categoryRepository.findById(documentForm.getCategory_id())
                    .orElseThrow(() -> new RuntimeException("Catégorie introuvable : " + documentForm.getCategory_id()));Category category = categoryRepository.findById(documentForm.getCategory_id())
