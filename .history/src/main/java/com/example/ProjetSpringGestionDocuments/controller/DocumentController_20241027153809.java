...
import org.springframework.web.bind.annotation.GetMapping; // Ensure this import is included
...
public class DocumentController {
    ...
    @GetMapping("/add-document") // New method to show the add document form
    ...
    public String addDocument(@RequestParam String title, @RequestParam String author,
        ...
        if (!documentFile.isEmpty()) {
            String filePath = uploadDir + "/" + documentFile.getOriginalFilename(); // Using the uploadDir variable
            try {
