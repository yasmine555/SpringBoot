...
public class DocumentController {
    ...
    public String addDocument(@RequestParam String title, @RequestParam String author,
                          ...
                          @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate publishDate, // consider using LocalDate
    ...
    try {
        ...
        document.setPublishDate(java.sql.Date.valueOf(publishDate)); // convert LocalDate to java.sql.Date
